...
TF_Frontal_Cortex <- 'c9orf72/project_2022-10-15/SJAR/Frontal_Cortex/output_tf/consensus_network_ncol_.txt'
Sig_Frontal_Cortex <- 'c9orf72/project_2022-10-15/SJAR/Frontal_Cortex/output_sig/consensus_network_ncol_.txt'
...
project_Frontal_Cortex <- sprintf('driver_%s','Frontal_Cortex' ) # project name for the project folders under main directory
...
analysis.par  <- NetBID.analysis.dir.create(project_main_dir=project_main_dir, project_name=project_Frontal_Cortex,
                                            network_dir=network.dir, tf.network.file=TF_Frontal_Cortex, sig.network.file=Sig_Frontal_Cortex)
...
G1  <- rownames(phe_info)[which((phe_info$group=='ALS') & (phe_info$tissue=='Frontal Cortex'))] # Experiment group
G0  <- rownames(phe_info)[which((phe_info$group=='Healthy') & (phe_info$tissue=='Frontal Cortex'))] # Control group
